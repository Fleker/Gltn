...
window.uiz = ui;
  ui.prepareUI = function () {
    if (! (document.readyState == "complete" || document.readyState == "interactive")) {
      ...
      console.log("Searching for templates interface");
    var container = ui.container = $(templates("interface"));
      uiz.templatefnc = templates;
      uiz.container = container;
//      uiz.templatefnci = $(templates.interface);
//      console.log($(templates.interface));
//    assert(container.length);
//      console.error($(container));
//      console.log(ui.container);
//      console.log($(templates['interface']));
      //We don't want that to happen immediately
