...
(function (root, factory) {
    ...
    if (this._options.steps) {
      ...
      for (var i = 0, stepsLength = this._options.steps.length; i < stepsLength; i++) {
        ...
        if (typeof(currentItem.element) === 'string') {
          //grab the element with given selector from the page
		  var cie = document.querySelector(currentItem.element);
		  if(cie != null)
         	 currentItem.element = cie;
        }
        introItems.push(currentItem);
		window.introitems = introItems;
      }
  ...
  function _showElement(targetElement) {
    ...
    if (typeof (this._introChangeCallback) !== 'undefined') {
        this._introChangeCallback.call(this, elementStringToObj(targetElement.element));
    }

    var self = this,
        oldHelperLayer = document.querySelector('.introjs-helperLayer'),
        elementPosition = _getOffset(elementStringToObj(targetElement.element));
  ...
  function _getPropValue (element, propName) {
    ...
    if (element.currentStyle) { //IE
      ...
      propValue = document.defaultView.getComputedStyle(elementStringToObj(element), null).getPropertyValue(propName);
    }
  ...
  function _elementInViewport(el) {
    var rect = elementStringToObj(el).getBoundingClientRect();
  ...
  function _getOffset(element) {
	...
	element = elementStringToObj(element);
    //set width
	try {
    ...
    //calculate element top and left
		...
		while(element && !isNaN(element.offsetLeft) && !isNaN(element.offsetTop)) {
			//Forked code - Have to use jQuery
