...
<br>
    ...
    <div id="panels" class="page row" style="background-color:#e7842c;">
        ...
        <div class="center"><img src="images/ideapanel2.png" class="promo"></div>
    ...
    <div id="intuitiveness" class="page row" style="background-color:#e74c3c;">
        ...
        <div class="center"><img src="images/intuitive2.png" class="promo"></div>
    ...
    <div id="html" class="page row" style="background-color:#9b59b6;">
        ...
        <div class="center"><img src="images/upload.png" class="promo"></div>
